#!/usr/bin/env python3
# GNU AGPLv3
# based on work by: https://github.com/yantisj/tcpping
"""
TCP Ping Test
"""
...
def tcpping(d_host, d_port=80, maxCount=10, DEBUG=False):
    ...
    return {'d_host':d_host, 'd_port':d_port,'count':COUNT, 'passed':PASSED, 'failed':FAILED,'average':round(AVG,3), 'lost_rate':lRate}

# Dummy destination for local test
if __name__ == "__main__":
    tcpping(d_host='192.168.1.1', d_port=80, maxCount=10, DEBUG=True)
